      ...
      >
        ...
        <View style={styles.table}>
          <View style={[styles.headerTableRow, styles.TableRowColorGrey]}>
            ...
            <View style={styles.headerTableColImage}>Фото</View>
            ...
            return (
              ...
              >
                ...
                <View style={styles.bodyTableColImage}>
                  <Image
                    style={styles.bodyTableColImage}
                    src={item["URL-Изображения"]}
                  />
                </View>
        ...
        {conditions.length > 0 ? (
          <View style={styles.ConditionBlock}>
            <View style={styles.ConditionBlockTitle}>
              <Text style={[styles.ConditionBlockTitleText, styles.BoldText]}>
                Условия предоставления услуги.
              </Text>
            </View>
            <View style={styles.ConditionBlockСontent}>
              {conditions.map((item, index) => (
                <View style={styles.ConditionBlockСontentItem} key={item.id}>
                  <Text style={styles.ConditionBlockСontentText}>
                    - {item.text}
                  </Text>
                </View>
              ))}
